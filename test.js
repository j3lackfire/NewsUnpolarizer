...
let paragraph = "They join previous waves of muslim immigrants , many of whom who are not integrating well. They join previous waves of muslim immigrants , many of whom who are not integrating well. " +
...
openieProcessor.extractFilteredOpenIeFromParagraph(paragraph, (err, result) => {
    utils.logFullObject(result)
})
