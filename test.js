...
const tripletProcessor = require('./NLPHandler/tripletProcessor')
...
let paragraph = "Over the past few years, unprecedented numbers of immigrants have left Muslim-majority countries to come to Europe, fleeing the carnage in Syria and the turmoil across North Africa."

openieProcessor.extractOpenIeFromParagraph(paragraph, (err, result) => {
    tripletProcessor.filterOpenieResult(result)
...
//         console.log(p)
//         openieProcessor.extractOpenIeFromParagraph(p, (err, result) => {
//             tripletProcessor.filterOpenieResult(result)
//             // utils.logFullObject(result)
//         })
